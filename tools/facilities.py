...
# 2026-08-31 ユーザー判断: 消防水利（消火栓・防火水槽）は一般利用者向けでは
# ないため収集・配信の対象外にした。復活させる場合はここと KIND_TITLE_KEYWORDS、
# KIND_LABELS、FALLBACK_NAMES に "fire_water" を戻す
SEARCH_QUERIES = [
...
FALLBACK_NAMES = {"water": "給水拠点", "stock": "防災倉庫"}

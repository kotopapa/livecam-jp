...
class AppLocalizationsJa extends AppLocalizations {
  ...
  String get mapLayerUnderpassSubtitle =>
      '自治体の冠水センサーによる通行可・注意・止め・冠水検知（千葉市・さいたま市・柏市・平塚市・静岡市・掛川市・静岡県・福井県・兵庫県・加古川市・高松市・佐世保市）';
...
class AppLocalizationsJaHira extends AppLocalizationsJa {
  ...
  @override
  String get mapLayerUnderpassSubtitle =>
      'とおれる・ちゅうい・とおれない（ちばし・さいたまし・かしわし・ひらつかし・しずおかし・かけがわし・しずおかけん・ふくいけん・ひょうごけん・かこがわし・たかまつし・させぼし）';

/// JIS都道府県コード（01〜47）→ 日本語表示名。
///
/// **UIの表示には使わないこと。** 1.4.0 以降、画面に出す都道府県名は
/// `l10n/l10n.dart` の `prefectureNameOf(l10n, code)` で解決する。
/// この表は「コードの正準な集合」と、気象庁データ（日本語）との突合
/// （heat_alert の prefNames 等）に使う。
const Map<String, String> prefectureNames = {

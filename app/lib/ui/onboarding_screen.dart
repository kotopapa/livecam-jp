            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  // ボタン群は右寄せの内側Rowにまとめる。外側で Spacer と Flexible を並べると
                  // 両者が flex:1 で残り幅を等分し、ボタンが半分の幅に制限されて
                  // 「同意してはじめる」が省略され、「次へ」の位置もページごとにズレる
                  Expanded(
                    child: Row(
                        ...
                        if (!_isLast) ...[
                          Flexible(
                            child: TextButton(
                              ...
                              onPressed: () =>
                                  _controller.jumpToPage(_pageCount),
                              child: Text(
                                l10n.commonSkip,
                                maxLines: 1,
...
class _PromisePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, c) {
        final imageHeight = c.maxHeight * 0.42 < 220.0
            ? c.maxHeight * 0.42
            : 220.0;

...
export const THEMES: Record<string, Theme> = {
  // 全国ライブカメラ地図: mineral blue / deep ink. Per-scene surfaces live below.
  "livecam-sky": {
    id: "livecam-sky",
    name: "LiveCam Sky",
    bg: "#EAF4FA",
...
// Only consumed by livecam-sky. Radial light is exportable without blur filters.
// Order: river, map, typhoon, alerts, shelters, ranking, supplies, closing wall.
export const LIVECAM_SURFACES = [
  { paper: "#F3F9FC", middle: "#D5EAF5", edge: "#81B5D4", light: "92% 28%", ink: "#367CA1" },
  { paper: "#EEF8FC", middle: "#CDE7EF", edge: "#92C5D5", light: "12% 46%", ink: "#327D94" },
  { paper: "#081E36", middle: "#123B56", edge: "#28617A", light: "82% 18%", ink: "#A5DEEA" },
  { paper: "#F6F8FF", middle: "#DFE7F8", edge: "#A9BCDF", light: "86% 44%", ink: "#5376AE" },
  { paper: "#F1F9F9", middle: "#DAEDEB", edge: "#9BC9CA", light: "18% 32%", ink: "#41888D" },
  { paper: "#081D35", middle: "#173D65", edge: "#3A6690", light: "20% 16%", ink: "#ACD7FF" },
  { paper: "#F5F9FD", middle: "#DBEAF4", edge: "#ABC6DE", light: "80% 48%", ink: "#567F9E" },
  { paper: "#EFF7FC", middle: "#D6E9F7", edge: "#9FBFDE", light: "92% 8%", ink: "#3C79A7" },
] as const;
